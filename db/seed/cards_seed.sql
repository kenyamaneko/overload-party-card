...
VALUES
  ('NT-0001', 'ロードバランサー', '', 'Neutral', 'Attachment', NULL,
   false, false, '{}'::jsonb,
   '自分のフロントエンドに装備できる。自分のフィールドにこのカードの装備先以外のフロントエンドリソースが 1体以上いる限り、相手はこのカードの装備先を攻撃対象に選択できない。',
   '[{"trigger": "on_deploy", "custom": "target_shield"}]'::jsonb,
   'unlimited', true),

  ('NT-0002', 'オートスケーラー', '', 'Neutral', 'Attachment', NULL,
   false, false, '{}'::jsonb,
  ...
  ('NT-0003', 'プライベートサブネット', '', 'Neutral', 'Attachment', NULL,
   false, false, '{}'::jsonb,
   '自分の コンピュート系リソース または DB系リソースに装備できる。装備先のカードはインシデントカードの効果の対象にならない',
   '[{"trigger": "on_deploy", "ops": [{"apply_buff": {"selector": "source", "buff": "incident_immune", "amount": 1, "duration": "while_on_field"}}]}]'::jsonb,
   'unlimited', true),

  ('NT-0004', 'マルチ AZ', '', 'Neutral', 'Attachment', NULL,
   false, false, '{}'::jsonb,
   '自分のリソースに装備できる。装備先のカードの可用性を +500 する。',
   '[{"trigger": "on_deploy", "ops": [{"apply_buff": {"selector": "source", "buff": "av", "amount": 500, "duration": "while_on_field"}}]}]'::jsonb,
   'unlimited', true),
  ...
  ('NT-0009', '寺リフォーム', '', 'Neutral', 'Strategy', NULL,
   ...
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"search_repo": {}}]}]'::jsonb,
   'limited', true),
  ...
  ('NT-0012', 'オープンソースマイグレーション', '', 'Neutral', 'Strategy', NULL,
   ...
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"destroy_platform": {}}]}]'::jsonb,
   'unlimited', true),

  ('NT-0013', 'DDoS 攻撃', '', 'Neutral', 'Incident', NULL,
   false, false, '{}'::jsonb,
   'Budget 400 を払って発動できる。相手のフロントエンドから選択した1体に 500 ダメージを与える',
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"deal_damage": {"selector": {"owner": "opponent", "zone": "frontend", "pick": "choice"}, "amount": 500}}, {"destroy_check": {"target": "opponent"}}]}]'::jsonb,
   'unlimited', true),

  ('NT-0014', 'データ流出', '', 'Neutral', 'Incident', NULL,
   false, false, '{}'::jsonb,
   'Budget 600 を払って発動できる。相手のDB系リソースまたはオブジェクトストレージから選択した1体に 600 ダメージを与え、相手の Budget を -300 する',
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"deal_damage": {"selector": {"owner": "opponent", "zone": "backend", "pick": "choice"}, "amount": 600, "budget_damage": 300}}, {"destroy_check": {"target": "opponent"}}]}]'::jsonb,
   'unlimited', true),

  ('NT-0015', '設定ミス', '', 'Neutral', 'Incident', NULL,
   false, false, '{}'::jsonb,
   'Budget 200 を払って発動できる。相手のフロントエンドから選択した1体のスループットを次ターン終了まで 0 にする',
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"apply_buff": {"selector": {"owner": "opponent", "zone": "frontend", "pick": "choice"}, "buff": "tp_suppressed", "amount": 1, "duration": "until_next_turn_end"}}]}]'::jsonb,
   'unlimited', true),

  ('NT-0016', 'データスクレイピング', '', 'Neutral', 'Incident', NULL,
   false, false, '{}'::jsonb,
   'Budget 300 を払って発動できる。相手の Insight を 600 吸収する。',
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "guard": [{"count": {"selector": {"owner": "opponent", "zone": "backend"}, "min": 1}}], "ops": [{"absorb_insight": {"amount": 600}}]}]'::jsonb,
   'unlimited', true),

  ('NT-0017', 'クローラーボット', '', 'Neutral', 'Incident', NULL,
   false, false, '{}'::jsonb,
   'Budget 100 を払って発動できる。相手の Insight を 300 吸収する。',
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"absorb_insight": {"amount": 300}}]}]'::jsonb,
   'unlimited', true),

  ('NT-0018', 'リージョン障害', '', 'Neutral', 'Incident', NULL,
   false, false, '{}'::jsonb,
   'Budget 600 を払って発動できる。フィールドの全てのリソースに 500 ダメージを与える',
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"deal_damage": {"selector": {"owner": "both"}, "amount": 500}}, {"destroy_check": {"target": "both"}}]}]'::jsonb,
   'unlimited', true),
  ...
  ('NT-0023', 'フェイルオーバー', '', 'Neutral', 'Reactive', NULL,
   false, false, '{}'::jsonb,
   '自分のリソースが破壊された時に発動する。手札から同じカード名のリソースをデプロイコストなしでデプロイできる。',
   '[{"trigger": "on_destroy", "custom": "deploy_same_type_from_hand", "meta": {"categories": ["deploy_free"]}}]'::jsonb,
   'unlimited', true),

  ('NT-0024', 'カオスエンジニアリング', '', 'Neutral', 'Reactive', NULL,
   false, false, '{}'::jsonb,
   '相手が自分のリソースを攻撃した時に発動する。その攻撃を無効にする。さらに、相手が選択した相手のフロントエンドに、攻撃したリソースのスループット分のダメージを与える（フロントエンドが1枚しかない場合は、攻撃したリソース自身が対象になる）',
   '[{"trigger": "on_attack_declared", "custom": "redirect_attack", "meta": {"categories": ["cancel_action"]}, "ops": [{"cancel_action": {}}]}]'::jsonb,
   'unlimited', true),
  ...
  ('NT-0028', '天気使いの更新', '', 'Neutral', 'Reactive', NULL,
   false, false, '{}'::jsonb,
   '相手が自分のリソースを攻撃した時に発動する。フィールドの全ての 天気使い リソースに 400 ダメージを与える。',
   '[{"trigger": "on_attack_declared", "ops": [{"deal_damage": {"selector": {"owner": "both", "faction": "Tenki"}, "amount": 400}}, {"destroy_check": {"target": "both"}}]}]'::jsonb,
   'unlimited', true),

  ('NT-0029', 'ITストラテジスト', '', 'Neutral', 'Strategy', NULL,
   false, false, '{}'::jsonb,
   'Budget 200 を払って発動できる。リポジトリからストラテジーカード1枚を選択して手札に加える。',
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"search_repo": {"card_type": "Strategy"}}]}]'::jsonb,
   'unlimited', true),

  ('NT-0030', 'リラックスペンギン', 'On-premises', 'Neutral', 'Compute', 'VM',
   false, false, '{"throughput": 400, "availability": 800, "sla_penalty": 300, "maintenance_cost": 100}'::jsonb,
   NULL,
   NULL,
   'unlimited', true),

  ('NT-0031', 'エレファントDB', 'On-premises', 'Neutral', 'DataResource', 'Database',
   false, false, '{"yield": 200, "availability": 700, "sla_penalty": 500, "maintenance_cost": 100}'::jsonb,
   NULL,
   NULL,
   'unlimited', true),

  ('NT-0032', '天気使いサーバー', 'On-premises', 'Neutral', 'Compute', 'VM',
   false, false, '{"throughput": 400, "availability": 800, "sla_penalty": 300, "maintenance_cost": 100}'::jsonb,
...
**Cloud Shift:** 手札から 調律部 DB系リソースをデプロイコスト -500 でデプロイできる。その後、このカードをトラッシュに送る。',
  ...
  ('NT-0034', 'スロットリング', '', 'Neutral', 'Reactive', NULL,
   ...
   '[{"trigger": "on_deploy", "use_limit": "once_per_turn", "guard": [{"event_owner": "opponent"}], "custom": "cancel_nth_deploy", "meta": {"categories": ["cancel_action"], "target": "all_opp"}}]'::jsonb,
   'unlimited', true),

  ('SH-0001', 'えくぼ', 'Compute', 'SHE', 'Compute', 'VM',
   true, false, '{"throughput": 700, "availability": 1400, "sla_penalty": 400, "maintenance_cost": 150}'::jsonb,
   NULL,
   NULL,
   'unlimited', true),

  ('SH-0002', 'アリゲーテナ', 'Container', 'SHE', 'Compute', 'Container',
   false, true, '{"throughput": 500, "availability": 1200, "sla_penalty": 400, "maintenance_cost": 50}'::jsonb,
   NULL,
   NULL,
   'unlimited', true),

  ('SH-0003', 'クジラの統率者<クジランティス>', 'Orchestrator', 'SHE', 'Compute', 'Orchestrator',
   true, true, '{"throughput": 600, "availability": 1500, "sla_penalty": 600, "maintenance_cost": 100}'::jsonb,
   NULL,
   NULL,
   'unlimited', true),

  ('SH-0004', 'ラフメイカー', 'ML', 'SHE', 'Compute', 'AI/ML',
  ...
  ('SH-0007', 'オオロバ', 'DistributedDB', 'SHE', 'DataResource', 'Database',
   ...
   '[{"trigger": "on_field_change", "ops": [{"apply_buff": {"selector": "source", "buff": "yield", "amount": {"base": 0, "per": {"count": {"owner": "myself", "zone": "backend", "faction": "SHE", "card_type": "DataResourcease", "exclude": "source"}, "value": 200}}, "duration": "this_turn"}}]}]'::jsonb,
   'unlimited', true),
  ...
  ('SH-0009', 'ダイノ', 'NoSQL', 'SHE', 'DataResource', 'Database',
  ...
  ('SH-0010', 'メリーモ', 'Cache', 'SHE', 'DataResource', 'CacheDB',
  ...
  ('SH-0015', 'SHE Queue', '', 'SHE', 'Attachment', NULL,
   ...
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"apply_buff": {"selector": "source", "buff": "tp", "amount": 600, "duration": "this_turn"}}]}]'::jsonb,
   'unlimited', true),

  ('SH-0016', 'SHE Gateway', '', 'SHE', 'Attachment', NULL,
   false, false, '{}'::jsonb,
   'フロントエンドリソースに装備できる。装備したリソースのスループットを +200 する。',
   '[{"trigger": "on_deploy", "ops": [{"apply_buff": {"selector": "source", "buff": "tp", "amount": 200, "duration": "while_on_field"}}]}]'::jsonb,
   'unlimited', true),
  ...
  ('SH-0018', 'SHE Formation', '', 'SHE', 'Strategy', NULL,
   ...
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"search_repo": {"faction": "SHE"}}]}]'::jsonb,
   'unlimited', true),
  ...
  ('SH-0021', 'Smile Recovery', '', 'SHE', 'Reactive', NULL,
   false, false, '{}'::jsonb,
   '自分の SHE リソースの可用性が 400 以下になった時に発動する。そのリソースの可用性を +500 する。',
   '[{"trigger": "on_damaged", "guard": [{"match": {"selector": "target", "faction": "SHE"}}, {"stat": {"selector": "target", "stat": "av", "max": 400}}], "ops": [{"heal_damage": {"selector": "target", "amount": 500}}]}]'::jsonb,
   'unlimited', true),
  ...
  ('SH-0023', 'SHE Smile Horizon Express', '', 'SHE', 'Strategy', NULL,
   ...
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"deploy_from_hand": {}}]}]'::jsonb,
   'unlimited', true),

  ('SH-0024', 'だっくん', 'Cache', 'SHE', 'DataResource', 'CacheDB',
  ...
  ('SL-0006', 'バター君', 'AI', 'Sugar', 'Compute', 'AI/ML',
  ...
  ('SL-0007', 'Dr. テンソルベ', 'AI', 'Sugar', 'Compute', 'AI/ML',
...
**Cascade Failure:** このカードが破壊された時に発動する。自分の全てのバックエンドに 400 ダメージを与える。',
  ...
  ('SL-0010', 'トーストア', 'NoSQL', 'Sugar', 'DataResource', 'Database',
   ...
   '[{"trigger": "on_deploy", "ops": [{"gain_insight": {"amount": 200}}]}]'::jsonb,
   'unlimited', true),

  ('SL-0011', 'アイスクエリム', 'Datawarehouse', 'Sugar', 'DataResource', 'Database',
  ...
  ('SL-0012', 'メレンゲスト', 'Cache', 'Sugar', 'DataResource', 'CacheDB',
   true, false, '{"yield": 200, "availability": 1200, "sla_penalty": 100, "maintenance_cost": 100}'::jsonb,
   '**Cache Engine:** デプロイ時に、以下の効果のうち1つを選択して発動する。 — **Memcached:** 自分の Budget を +400 する / **Redis:** このカードの Yield を +200 する。',
   '[{"trigger": "on_deploy", "choice": {"memcached": [{"gain_budget": {"target": "myself", "amount": 400}}], "redis": [{"apply_buff": {"selector": "source", "buff": "yield", "amount": 200, "duration": "permanent"}}]}}]'::jsonb,
   'unlimited', true),

  ('SL-0013', 'シュトレーンジ', 'Storage', 'Sugar', 'DataResource', 'ObjectStorage',
  ...
  ('SL-0017', 'しゅがーらぼ Profiler', '', 'Sugar', 'Attachment', NULL,
   false, false, '{}'::jsonb,
  ...
  ('SL-0019', 'しゅがーらぼ だんごフロー', '', 'Sugar', 'Attachment', NULL,
   ...
   '[{"trigger": "on_deploy", "ops": [{"apply_buff": {"selector": "source", "buff": "yield", "amount": 400, "duration": "while_on_field"}}, {"apply_buff": {"selector": "source", "buff": "sla_penalty", "amount": 100, "duration": "while_on_field"}}]}]'::jsonb,
   'unlimited', true),
  ...
  ('SL-0021', 'しゅがーらぼ Deployment', '', 'Sugar', 'Strategy', NULL,
   ...
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"search_repo": {"faction": "Sugar"}}]}]'::jsonb,
   'unlimited', true),
  ...
  ('SL-0024', 'しゅがーらぼ Error Budget', '', 'Sugar', 'Reactive', NULL,
   false, false, '{}'::jsonb,
   '自分の しゅがーらぼ リソースが破壊される攻撃を受けた時に発動する。その攻撃を無効化し、このターン中そのリソースは攻撃の対象にならない。ただし、次の自分のターン、そのリソースは攻撃できない。',
   '[{"trigger": "on_attack_declared", "guard": [{"match": {"selector": "target", "faction": "Sugar"}}, {"lethal": true}], "ops": [{"survive_destruction": {"av": 200}}]}]'::jsonb,
   'unlimited', true),

  ('TK-0001', 'ソラ', 'VM', 'Tenki', 'Compute', 'VM',
  ...
  ('TK-0004', '空即蒼色', 'Orchestrator', 'Tenki', 'Compute', 'Orchestrator',
  ...
  ('TK-0005', '智の解放者<オープナー>', 'AI', 'Tenki', 'Compute', 'AI/ML',
   ...
   '[{"trigger": "on_field_change", "ops": [{"apply_buff": {"selector": "source", "buff": "tp", "amount": {"base": 0, "per": {"count": {"owner": "myself", "zone": "backend", "faction": "Tenki", "card_type": "DataResource"}, "value": 200}}, "duration": "this_turn"}}]}]'::jsonb,
   'unlimited', true),
  ...
  ('TK-0007', 'シグレ', 'RDB', 'Tenki', 'DataResource', 'Database',
  ...
  ('TK-0010', '百花の天穹<コスモ>', 'NoSQL', 'Tenki', 'DataResource', 'Database',
...
**百花繚乱:** このカードをデプロイした時に発動できる。リポジトリから「天気使い NoSQL - 秩序の蒼<コスモ>」1枚をコストなしでデプロイする。この効果は1ターン中に1回のみ使用できる',
   '[{"trigger": "on_deploy", "ops": [{"apply_buff": {"selector": "source", "buff": "count_multiplier", "amount": 2, "duration": "while_on_field"}}]}, {"trigger": "on_deploy", "use_limit": "once_per_turn", "ops": [{"deploy_from_repo": {"filter": {"card_id": "TK-0010"}}}]}]'::jsonb,
   'unlimited', true),

  ('TK-0011', 'シュウウ', 'Cache', 'Tenki', 'DataResource', 'CacheDB',
  ...
  ('TK-0016', '天気使い 空の入口', '', 'Tenki', 'Attachment', NULL,
   false, false, '{}'::jsonb,
   '自分のリソースに装備できる。装備先へのインシデントカードによるダメージを -200 する。',
   '[{"trigger": "on_deploy", "ops": [{"apply_buff": {"selector": "source", "buff": "incident_reduction", "amount": 200, "duration": "while_on_field"}}]}]'::jsonb,
   'unlimited', true),
  ...
  ('TK-0019', '天気使い ブロックストレージ', '', 'Tenki', 'Attachment', NULL,
   false, false, '{}'::jsonb,
   '自分の「天気使い VM - ソラ」にのみ装備できる。装備先の可用性を +300 し、スループットを +200 する。',
   '[{"trigger": "on_deploy", "ops": [{"apply_buff": {"selector": "source", "buff": "av", "amount": 300, "duration": "while_on_field"}}, {"apply_buff": {"selector": "source", "buff": "tp", "amount": 200, "duration": "while_on_field"}}]}]'::jsonb,
   'unlimited', true),

  ('TK-0020', '天気使い Template', '', 'Tenki', 'Strategy', NULL,
   false, false, '{}'::jsonb,
   'Budget 200 を払って発動できる。リポジトリから 天気使い リソース1枚を選択して手札に加える。',
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"search_repo": {"faction": "Tenki"}}]}]'::jsonb,
   'unlimited', true),
  ...
  ('TK-0022', '天気使い Policy', '', 'Tenki', 'Strategy', NULL,
   ...
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"apply_buff": {"selector": {"owner": "opponent", "zone": "frontend"}, "buff": "incident_block", "amount": 1, "duration": "this_turn"}}]}]'::jsonb,
   'unlimited', true),

  ('TK-0023', '天気使い お守り傘', '', 'Tenki', 'Reactive', NULL,
   false, false, '{}'::jsonb,
   '相手がインシデントカードを使用した時に発動する。そのインシデントを無効化する。',
   '[{"trigger": "on_incident", "guard": [{"event_owner": "opponent"}], "ops": [{"cancel_action": {}}]}]'::jsonb,
   'unlimited', true),
  ...
  ('TN-0002', 'ベア太', 'Bare Metal', 'Tuners', 'Compute', 'VM',
  ...
  ('TN-0003', 'テナ', 'Container', 'Tuners', 'Compute', 'Container',
  ...
  ('TN-0014', '調律部 ノーツガード', '', 'Tuners', 'Attachment', NULL,
   ...
   '[{"trigger": "on_destroy", "use_limit": "once_per_game", "ops": [{"deploy_from_repo": {"filter": {"faction": "Tuners", "card_type": "DataResourcease"}, "override_av": 200}}]}]'::jsonb,
   'unlimited', true),

  ('TN-0015', '調律部 リアル・アンサンブル・クラスター', '', 'Tuners', 'Attachment', NULL,
   false, false, '{}'::jsonb,
   '自分の 調律部 DB系リソースに装備できる。装備先の可用性を +400 する。装備先へのインシデントカードによるダメージを -200 する。',
   '[{"trigger": "on_deploy", "ops": [{"apply_buff": {"selector": "source", "buff": "av", "amount": 400, "duration": "while_on_field"}}, {"apply_buff": {"selector": "source", "buff": "incident_reduction", "amount": 200, "duration": "while_on_field"}}]}]'::jsonb,
   'unlimited', true),

  ('TN-0016', '調律部 Block Volume', '', 'Tuners', 'Attachment', NULL,
   false, false, '{}'::jsonb,
   '自分の「調律部 Compute - コンタータ」または「調律部 Bare Metal - ベア太」にのみ装備できる。装備先の可用性を +800 する。装備先へのインシデントカードによるダメージを -100 する。',
   '[{"trigger": "on_deploy", "ops": [{"apply_buff": {"selector": "source", "buff": "av", "amount": 800, "duration": "while_on_field"}}, {"apply_buff": {"selector": "source", "buff": "incident_reduction", "amount": 100, "duration": "while_on_field"}}]}]'::jsonb,
   'unlimited', true),

  ('TN-0017', '調律部 License', '', 'Tuners', 'Strategy', NULL,
   false, false, '{}'::jsonb,
   'Budget 100 を払って発動できる。自分の 調律部 DB系リソース1体の可用性を最大値まで回復する。',
   '[{"trigger": "ignition", "use_limit": "once_per_turn", "ops": [{"heal_damage": {"selector": {"owner": "myself", "zone": "backend", "faction": "Tuners", "card_type": "DataResourcease", "pick": "choice"}, "amount": {"ref": "target.max_av", "multiply": 1}}}]}]'::jsonb,
   'unlimited', true),

  ('TN-0018', '調律部 Failback', '', 'Tuners', 'Reactive', NULL,
   false, false, '{}'::jsonb,
   '自分の 調律部 DB系リソースが破壊された時に発動する。手札から 調律部 DB系リソース1枚をデプロイコストなしでデプロイする。',
   '[{"trigger": "on_destroy", "guard": [{"match": {"selector": "target", "faction": "Tuners", "card_type": "DataResourcease"}}], "ops": [{"deploy_from_hand": {"filter": {"faction": "Tuners", "card_type": "DataResourcease"}}}]}]'::jsonb,
   'unlimited', true)
